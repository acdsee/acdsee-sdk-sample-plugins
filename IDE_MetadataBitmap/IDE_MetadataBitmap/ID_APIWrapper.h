...
//This is a wrapper around the ACDSee Image Decoding Plug-In API. An instance of this class is created on init and deleted on free.
class ID_APIWrapper
{
public:
   ...
   int DoGetMetadataList(ID_StateHdl hs, int iPage, int nMetaTypes, GUID* guidTypes, MD_MetadataList* pList);
